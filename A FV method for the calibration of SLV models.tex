...
&& + \ \left. \left[ \left. \left[ \sigma_{12} p \right] \right\vert_{x=x_{i-0.5}}^{x=x_{i+0.5}} \right] \right\vert_{y=y_{j-0.5}}^{y=y_{j+0.5}} \frac{2}{\Delta x_{i} + \Delta x_{i+1}} \frac{2}{\Delta y_{j} + \Delta y_{j+1}} . \slabel{eq:FluxXY}
\end{subeqnarray}
